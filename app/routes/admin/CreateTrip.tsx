  ...
  return (
    <main className="flex flex-col gap-10 pb-20 wrapper">
      <Header
        ...
        description="View and edit AI Genearted travel plans"
      />
        ...
        >
          ...
          <div>
            ...
            <input
              id="duration"
              name="duration"
              placeholder="Enter a number of days (5, 8 ...)"
              className="form-input placholder:text-gray-100"
          ...
          <div className="b-gray-200 h-px w-full" />
          {error && (
            <div className="error">
              <p>{error}</p>
            </div>
